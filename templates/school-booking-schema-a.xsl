...
<xsl:stylesheet xmlns:school-booking="school-booking" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:pekoe="http://www.gspring.com.au/pekoe" xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0">
    <xsl:include href="/db/pekoe-system/common.xsl"/>
    <xsl:function name="school-booking:address-on-one-line">
        <xsl:param name="path"/><!--Has output xpath-->
